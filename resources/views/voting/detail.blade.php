    ...
    ">
        ...
        ">
            ...
            <div>
                ...
                max-w-xs
                ">
                    Platform voting digital untuk berbagai event.
                    Mudah, cepat, transparan, dan realtime.
                </p>
            ...
            <div>
                ...
                <div class="mt-4 space-y-3 text-sm text-gray-500">
                    ...
                    <button type="button" data-footer-tab="ranking" class="block hover:text-blue-600">
                        Ranking
                    </button>

                    <a href="{{ route('home') }}#cara-vote" class="block hover:text-blue-600">
                        Cara Vote
                    </a>
